...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/bold-moon-6cbc)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bold-moon-6cbc
```

A live public deployment of this template is available at [https://bold-moon-6cbc.templates.workers.dev](https://bold-moon-6cbc.templates.workers.dev)
